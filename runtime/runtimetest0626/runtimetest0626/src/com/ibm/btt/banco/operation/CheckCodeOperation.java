...
public class CheckCodeOperation extends BTTServerOperation {
	/***************************************************************************
	 ...
	 */
	public CheckCodeOperation(String anOperationName) throws java.io.IOException {
	 ...
	 *                The exception description.
	 */
	public CheckCodeOperation(String anOperationName, String aParentContext)
	 ...
	 *                The exception description.
	 */
	public CheckCodeOperation(String anOperationName, Context aParentContext)
	...
	public void execute() throws Exception {
		System.out.println("CheckCodeOperation");		
		OperationRepliedEvent event = new OperationRepliedEvent(this);
		Hashtable ht = new Hashtable();
		event.setParameters(ht);
		// if codeverification equals code value, reply to first page
		System.out.println("codeverification: "+getContext().getValueAt("basic.codeverification"));
		System.out.println("code: "+getContext().getValueAt("basic.code"));
		if ((getContext().getValueAt("basic.codeverification")).equals((getContext().getValueAt("basic.code")))){
			System.out.println("equals");
			ht.put(com.ibm.btt.automaton.ext.DSEOperationState.EXIT_EVENT_NAME,
			"Update");
		} 
		// else reply to error page
		else {
		...
		System.out.println("checkCodeOp is done");
	}
}