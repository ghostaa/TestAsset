...
public class RichTextOperation extends BTTServerOperation {
	/***************************************************************************
	 ...
	 */
	public RichTextOperation(String anOperationName) throws java.io.IOException {
	 ...
	 *                The exception description.
	 */
	public RichTextOperation(String anOperationName, String aParentContext)
	 ...
	 *                The exception description.
	 */
	public RichTextOperation(String anOperationName, Context aParentContext)
	...
	public void execute() throws Exception {
		System.out.println("RichText Operation");
		
		System.out.println("data from Client side   "+this.getValueAt("requiredBasicField"));
		this.setValueAt("requiredBasicField", "<ul><li>c<b>hanged value</b></li></ul>");

		System.out.println(this.getContext().getKeyedCollection());

		setValueAt(HtmlConstants.REPLYPAGE, "RichText.jsp");
	}
}