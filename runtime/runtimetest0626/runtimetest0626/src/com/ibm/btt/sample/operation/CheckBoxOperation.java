...
public class CheckBoxOperation extends BTTServerOperation {
	/***************************************************************************
	 ...
	 */
	public CheckBoxOperation(String anOperationName) throws java.io.IOException {
	 ...
	 *                The exception description.
	 */
	public CheckBoxOperation(String anOperationName, String aParentContext)
	 ...
	 *                The exception description.
	 */
	public CheckBoxOperation(String anOperationName, Context aParentContext)
	...
	public void execute() throws Exception {
		System.out.println("CheckBoxOperation");
		System.out.println("java value is "+getContext().getValueAt("java"));
		
		setValueAt("readonlySubmitValue2", getValueAt("readonlySubmitValue"));
		setValueAt("disableSubmitValue2", getValueAt("disableSubmitValue"));
		setValueAt(HtmlConstants.REPLYPAGE, "checkbox.jsp");
	}
}