...
public class RadioButtonOperation extends BTTServerOperation {
	/***************************************************************************
	 ...
	 */
	public RadioButtonOperation(String anOperationName) throws java.io.IOException {
	 ...
	 *                The exception description.
	 */
	public RadioButtonOperation(String anOperationName, String aParentContext)
	 ...
	 *                The exception description.
	 */
	public RadioButtonOperation(String anOperationName, Context aParentContext)
	...
	public void execute() throws Exception {
		System.out.println("RadioButtonOperation");
		
//		setValueAt("submitAnimal", this.getContext().getKeyedCollection().getElementAt("textFieldValue").getValue().toString());
		setValueAt(HtmlConstants.REPLYPAGE, "radioButtonByAjax.jsp");
	}
}