...
public class SimpleWidgetNlsRefreshPage extends BTTServerOperation {
	/***************************************************************************
	 ...
	 **************************************************************************/
	//protected final String PAGENAME = "nls/SimpleWidgetNls.jsp";
	//setValueAt(Constants.REPLYPAGE, "nls/SimpleWidgetNls.jsp");

	/**
	 * Constructs a SimpleWidgetNlsRefreshPage.
	 */
	public SimpleWidgetNlsRefreshPage() {
		super();
	}
	 ...
	 */
	public SimpleWidgetNlsRefreshPage(String anOperationName) throws java.io.IOException {
	 ...
	 *                The exception description.
	 */
	public SimpleWidgetNlsRefreshPage(String anOperationName, String aParentContext)
	 ...
	 *                The exception description.
	 */
	public SimpleWidgetNlsRefreshPage(String anOperationName, Context aParentContext)
