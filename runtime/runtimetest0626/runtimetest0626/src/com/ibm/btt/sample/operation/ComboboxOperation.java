...
public class ComboboxOperation extends BTTServerOperation {
	/***************************************************************************
	 ...
	 */
	public ComboboxOperation(String anOperationName) throws java.io.IOException {
	 ...
	 *                The exception description.
	 */
	public ComboboxOperation(String anOperationName, String aParentContext)
	 ...
	 *                The exception description.
	 */
	public ComboboxOperation(String anOperationName, Context aParentContext)
	...
	public void execute() throws Exception {
		System.out.println("ComboboxOperation");
		...
		System.out.println("ComboboxOperation is done");
		setValueAt(HtmlConstants.REPLYPAGE, "combobox.jsp");
	}
}