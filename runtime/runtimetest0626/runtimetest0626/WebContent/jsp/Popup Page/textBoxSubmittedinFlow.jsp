...
<html>
<!-- Generated from textBoxSubmittedinFlow.xui by Administrator, on Tue Jan 29 10:56:36 CST 2013 -->
<head>
...
<script type="text/javascript" src="<%=JSPUtil.getWebContextRootUrl()%>jsp/Popup Page/textBoxSubmittedinFlow.js"> </script>
  <table id="textBoxSubmittedinFlow_panel">
    <tr>
      <td align="left" valign="middle">
        <bttdojo:a id="textBoxSubmittedinFlow_link" text="link into first page." flowEvent="return" textWrap="false"/>
      </td>
    </tr>
    <tr>
      <td align="left" valign="middle">
    ...
    <tr>
      <td>
        <bttdojo:form id="textBoxSubmittedinFlow_form01" errorPage="Popup%20Page/textBoxSubmittedinFlow.jsp">
          <table>
            <tr>
              <td align="left" valign="middle">
                <bttdojo:group id="textBoxSubmittedinFlow_group" text="Basic Type Test- test whether the value can be submitted" width="674px" height="48px" textWrap="false">
                  <table style="width:674px;height:48px;">
                    <tr>
                      <td align="left" valign="middle">
                        <bttdojo:label id="textBoxSubmittedinFlow_label01" text="Basic Field" textWrap="false"/>
                      </td>
                      <td align="left" valign="middle">
                        <bttdojo:textbox id="textBoxSubmittedinFlow_text" dataName="BasicField" type="String" textWrap="false"/>
                      </td>
                      <td align="left" valign="middle">
    ...
    <tr>
      <td>
        <bttdojo:form id="textBoxSubmittedinFlow_form02" errorPage="Popup%20Page/textBoxSubmittedinFlow.jsp">
          <table>
            <tr>
              <td>
    ...
    <tr>
      <td>
        <bttdojo:form id="textBoxSubmittedinFlow_form03" errorPage="Popup%20Page/textBoxSubmittedinFlow.jsp">
          <table>
            <tr>
              <td>
    ...
    <tr>
      <td>
        <bttdojo:form id="textBoxSubmittedinFlow_form04" errorPage="Popup%20Page/textBoxSubmittedinFlow.jsp">
          <table>
            <tr>
              <td>
    ...
    <tr>
      <td>
        <bttdojo:form id="textBoxSubmittedinFlow_form05" errorPage="Popup%20Page/textBoxSubmittedinFlow.jsp">
          <table>
            <tr>
              <td>
    ...
    <tr>
      <td>
        <bttdojo:form id="textBoxSubmittedinFlow_form06" errorPage="Popup%20Page/textBoxSubmittedinFlow.jsp">
          <table>
            <tr>
              <td>
    ...
    <tr>
      <td>
        <bttdojo:form id="textBoxSubmittedinFlow_form07" errorPage="Popup%20Page/textBoxSubmittedinFlow.jsp">
          <table>
            <tr>
              <td>
    ...
    <tr>
      <td>
        <bttdojo:form id="textBoxSubmittedinFlow_form08" errorPage="Popup%20Page/textBoxSubmittedinFlow.jsp">
          <table>
            <tr>
              <td>
    ...
    <tr>
      <td>
        <bttdojo:form id="textBoxSubmittedinFlow_form" errorPage="Popup%20Page/textBoxSubmittedinFlow.jsp">
          <table>
            <tr>
              <td>
    ...
    <tr>
      <td>
        <bttdojo:form id="textBoxSubmittedinFlow_form09" errorPage="Popup%20Page/textBoxSubmittedinFlow.jsp">
          <table>
            <tr>
              <td>
    ...
    <tr>
      <td>
        <bttdojo:form id="textBoxSubmittedinFlow_form12" errorPage="Popup%20Page/textBoxSubmittedinFlow.jsp">
          <table>
            <tr>
              <td>
    ...
    <tr>
      <td>
        <bttdojo:form id="textBoxSubmittedinFlow_form13" errorPage="Popup%20Page/textBoxSubmittedinFlow.jsp">
          <table>
            <tr>
              <td>
    ...
    <tr>
      <td>
        <bttdojo:form id="textBoxSubmittedinFlow_form15" errorPage="Popup%20Page/textBoxSubmittedinFlow.jsp">
          <table>
            <tr>
              <td>
    ...
    <tr>
      <td>
        <bttdojo:form id="textBoxSubmittedinFlow_form16" errorPage="Popup%20Page/textBoxSubmittedinFlow.jsp">
          <table>
            <tr>
              <td>
    ...
    <tr>
      <td>
        <bttdojo:form id="textBoxSubmittedinFlow_form17" errorPage="Popup%20Page/textBoxSubmittedinFlow.jsp">
          <table>
            <tr>
              <td>
    ...
    <tr>
      <td>
        <bttdojo:form id="textBoxSubmittedinFlow_form19" errorPage="Popup%20Page/textBoxSubmittedinFlow.jsp">
          <table>
            <tr>
              <td>
    ...
    <tr>
      <td>
        <bttdojo:form id="textBoxSubmittedinFlow_form18" errorPage="Popup%20Page/textBoxSubmittedinFlow.jsp">
          <table>
            <tr>
              <td>
