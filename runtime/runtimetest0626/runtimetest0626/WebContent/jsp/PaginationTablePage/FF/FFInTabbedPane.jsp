...
<html>
<!-- Generated from FFInTabbedPane.xui by Administrator, on Mon Jan 28 14:33:20 CST 2013 -->
<head>
      ...
      <td align="left" valign="top">
        <bttdojo:form id="FFInTabbedPane_form" errorPage="PaginationTablePage/FF/FFInTabbedPane.jsp">
          <table>
                  ...
                  <table id="FFInTabbedPane_panel01">
                    <tr>
                      <td align="left" valign="middle">
                        <bttdojo:a id="FFInTabbedPane_link" text="FFtable" flowEvent="returnToTFTable" textWrap="false"/>
                      </td>
                      <td align="left" valign="middle">
                        <bttdojo:label id="FFInTabbedPane_label" text="-> FFInTabbedPane" textWrap="false"/>
                      </td>
                    </tr>
                  </table>
              </td>
            ...
            <tr>
              <td align="left" valign="top">
                <bttdojo:tabbedpane id="FFInTabbedPane_tabbedPane" textWrap="false">
                  <bttdojo:contentpane id="FFInTabbedPane_ContentPane01" title="NormalTab">
                    <table style="table-layout:fixed">
                      <tr>
                        <td align="left" valign="middle">
                          <bttdojo:table id="FFInTabbedPane_tableFF" dataNameForList="AccountInfoList" isPageable="true" textWrap="false" operationName="PAG_PaginationTablePage$FF$FFInTabbedPane_tableFF" directPagination="false" paginationWhenLoading="false" rowsPerPage="10">
                  ...
                  <bttdojo:contentpane id="FFInTabbedPane_ContentPane02" title="Group">
                    <table style="table-layout:fixed">
                      <tr>
                        <td align="left" valign="top">
                          <bttdojo:group id="FFInTabbedPane_group" text="Group" textWrap="false">
                            <table>
                              <tr>
                                <td align="left" valign="middle">
                                  <bttdojo:table id="FFInTabbedPane_tableFF1" dataNameForList="AccountInfoList" isPageable="true" textWrap="false" operationName="PAG_PaginationTablePage$FF$FFInTabbedPane_tableFF1" directPagination="false" paginationWhenLoading="false" rowsPerPage="10">
                                    <bttdojo:column widget="TextBox" align="left" dataName="AccountName" width="80" type="String" text="%nls.testtable/AccountName"/>
                                    <bttdojo:column dataNameForList="AccountTypeForSelect" widget="Select" align="left" dataName="AccountType" width="80" labelField="labelField" valueField="valueField" text="%nls.testtable/AccountType"/>
                                    <bttdojo:column widget="Select" align="left" dataName="TradeTime" width="80" text="%nls.testtable/TradeTime" storeURL="listFiles/tradeTimeForSelect.js"/>
                                    <bttdojo:column numberType="bigDecimal" widget="TextBox" align="left" dataName="MaximumAmount" width="80" type="Number" decimalPlaces="3" text="%nls.testtable/MaximumAmount"/>
                  ...
                  <bttdojo:contentpane id="FFInTabbedPane_ContentPane03" title="Pane">
                    <table style="table-layout:fixed">
                      <tr>
                        <td align="left" valign="top">
                          <bttdojo:tabbedpane id="FFInTabbedPane_tabbedPane01" textWrap="false">
                            <bttdojo:contentpane id="FFInTabbedPane_ContentPane04" title="Tab01">
                              <table style="table-layout:fixed">
                                <tr>
                                  <td align="left" valign="middle">
                                    <bttdojo:label id="FFInTabbedPane_label01" text="tab01" textWrap="false"/>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="left" valign="middle">
                                    <bttdojo:table id="FFInTabbedPane_tableFF2" dataNameForList="AccountInfoList" isPageable="true" textWrap="false" operationName="PAG_PaginationTablePage$FF$FFInTabbedPane_tableFF2" directPagination="false" paginationWhenLoading="false" rowsPerPage="10">
                                      <bttdojo:column widget="TextBox" align="left" dataName="AccountName" width="80" type="String" text="%nls.testtable/AccountName"/>
                                      <bttdojo:column dataNameForList="AccountTypeForSelect" widget="Select" align="left" dataName="AccountType" width="80" labelField="labelField" valueField="valueField" text="%nls.testtable/AccountType"/>
                                      <bttdojo:column widget="Select" align="left" dataName="TradeTime" width="80" text="%nls.testtable/TradeTime" storeURL="listFiles/tradeTimeForSelect.js"/>
                                      <bttdojo:column numberType="bigDecimal" widget="TextBox" align="left" dataName="MaximumAmount" width="80" type="Number" decimalPlaces="3" text="%nls.testtable/MaximumAmount"/>
                            ...
                            <bttdojo:contentpane id="FFInTabbedPane_ContentPane05" title="Tab02">
                              <table style="table-layout:fixed">
                                <tr>
                                  <td align="left" valign="middle">
                                    <bttdojo:label id="FFInTabbedPane_label02" text="tab02" textWrap="false"/>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="left" valign="middle">
                                    <bttdojo:table id="FFInTabbedPane_tableFF3" dataNameForList="AccountInfoList" isPageable="true" textWrap="false" operationName="PAG_PaginationTablePage$FF$FFInTabbedPane_tableFF3" directPagination="false" paginationWhenLoading="false" rowsPerPage="10">
                                      <bttdojo:column widget="TextBox" align="left" dataName="AccountName" width="80" type="String" text="%nls.testtable/AccountName"/>
                                      <bttdojo:column dataNameForList="AccountTypeForSelect" widget="Select" align="left" dataName="AccountType" width="80" labelField="labelField" valueField="valueField" text="%nls.testtable/AccountType"/>
                                      <bttdojo:column widget="Select" align="left" dataName="TradeTime" width="80" text="%nls.testtable/TradeTime" storeURL="listFiles/tradeTimeForSelect.js"/>
