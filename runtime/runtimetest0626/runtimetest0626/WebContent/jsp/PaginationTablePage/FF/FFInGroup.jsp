...
<html>
<!-- Generated from FFInGroup.xui by Administrator, on Mon Jan 28 14:33:18 CST 2013 -->
<head>
      ...
      <td align="left" valign="top">
        <bttdojo:form id="FFInGroup_form" errorPage="PaginationTablePage/FF/FFInGroup.jsp">
          <table>
                  ...
                  <table id="FFInGroup_panel01">
                    <tr>
                      <td align="left" valign="middle">
                        <bttdojo:a id="FFInGroup_link" text="FFtable" flowEvent="returnToTFtable" textWrap="false"/>
                      </td>
                      <td align="left" valign="middle">
                        <bttdojo:label id="FFInGroup_label" text="-> FFtable in group" textWrap="false"/>
                      </td>
                    </tr>
                  </table>
              </td>
            ...
            <tr>
              <td align="left" valign="top">
                <bttdojo:group id="FFInGroup_group" text="Group" textWrap="false">
                  <table>
                    <tr>
                      <td align="left" valign="middle">
                        <bttdojo:table id="FFInGroup_tableFF" dataNameForList="AccountInfoList" isPageable="true" textWrap="false" operationName="PAG_PaginationTablePage$FF$FFInGroup_tableFF" directPagination="false" paginationWhenLoading="false" rowsPerPage="10">
