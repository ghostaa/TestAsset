...
<html>
<!-- Generated from TFInTabbedPane.xui by Administrator, on Tue Jan 29 10:56:28 CST 2013 -->
<head>
      ...
      <td align="left" valign="top">
        <bttdojo:form id="TFInTabbedPane_form" errorPage="PaginationTablePage/TF/TFInTabbedPane.jsp">
          <table>
                  ...
                  <table id="TFInTabbedPane_panel01">
                    <tr>
                      <td align="left" valign="middle">
                        <bttdojo:a id="TFInTabbedPane_link" text="TFtable" flowEvent="returnToTFTable" textWrap="false"/>
                      </td>
                      <td align="left" valign="middle">
                        <bttdojo:label id="TFInTabbedPane_label" text="-> TFInTabbedPane" textWrap="false"/>
                      </td>
                    </tr>
                  </table>
              </td>
            ...
            <tr>
              <td align="left" valign="top">
                <bttdojo:tabbedpane id="TFInTabbedPane_tabbedPane" textWrap="false">
                  <bttdojo:contentpane id="TFInTabbedPane_ContentPane01" title="NormalTab">
                    <table style="table-layout:fixed">
                      <tr>
                        <td align="left" valign="middle">
                          <bttdojo:table id="TFInTabbedPane_tableTF" dataNameForList="AccountInfoList" isPageable="true" textWrap="false" operationName="PAG_PaginationTablePage$TF$TFInTabbedPane_tableTF" directPagination="true" paginationWhenLoading="false" rowsPerPage="10">
                  ...
                  <bttdojo:contentpane id="TFInTabbedPane_ContentPane02" title="Group">
                    <table style="table-layout:fixed">
                      <tr>
                        <td align="left" valign="top">
                          <bttdojo:group id="TFInTabbedPane_group" text="Group" textWrap="false">
                            <table>
                              <tr>
                                <td align="left" valign="middle">
                                  <bttdojo:table id="TFInTabbedPane_tableTF1" dataNameForList="AccountInfoList" isPageable="true" textWrap="false" operationName="PAG_PaginationTablePage$TF$TFInTabbedPane_tableTF1" directPagination="true" paginationWhenLoading="false" rowsPerPage="10">
                                    <bttdojo:column widget="TextBox" align="left" dataName="AccountName" width="80" type="String" text="%nls.testtable/AccountName"/>
                                    <bttdojo:column dataNameForList="AccountTypeForSelect" widget="Select" align="left" dataName="AccountType" width="80" labelField="labelField" valueField="valueField" text="%nls.testtable/AccountType"/>
                                    <bttdojo:column widget="Select" align="left" dataName="TradeTime" width="80" text="%nls.testtable/TradeTime" storeURL="listFiles/tradeTimeForSelect.js"/>
                                    <bttdojo:column numberType="bigDecimal" widget="TextBox" align="left" dataName="MaximumAmount" width="80" type="Number" decimalPlaces="3" text="%nls.testtable/MaximumAmount"/>
                  ...
                  <bttdojo:contentpane id="TFInTabbedPane_ContentPane03" title="Pane">
                    <table style="table-layout:fixed">
                      <tr>
                        <td align="left" valign="top">
                          <bttdojo:tabbedpane id="TFInTabbedPane_tabbedPane01" textWrap="false">
                            <bttdojo:contentpane id="TFInTabbedPane_ContentPane04" title="Tab01">
                              <table style="table-layout:fixed">
                                <tr>
                                  <td align="left" valign="middle">
                                    <bttdojo:label id="TFInTabbedPane_label01" text="tab01" textWrap="false"/>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="left" valign="middle">
                                    <bttdojo:table id="TFInTabbedPane_tableTF2" dataNameForList="AccountInfoList" isPageable="true" textWrap="false" operationName="PAG_PaginationTablePage$TF$TFInTabbedPane_tableTF2" directPagination="true" paginationWhenLoading="false" rowsPerPage="10">
                                      <bttdojo:column widget="TextBox" align="left" dataName="AccountName" width="80" type="String" text="%nls.testtable/AccountName"/>
                                      <bttdojo:column dataNameForList="AccountTypeForSelect" widget="Select" align="left" dataName="AccountType" width="80" labelField="labelField" valueField="valueField" text="%nls.testtable/AccountType"/>
                                      <bttdojo:column widget="Select" align="left" dataName="TradeTime" width="80" text="%nls.testtable/TradeTime" storeURL="listFiles/tradeTimeForSelect.js"/>
                                      <bttdojo:column numberType="bigDecimal" widget="TextBox" align="left" dataName="MaximumAmount" width="80" type="Number" decimalPlaces="3" text="%nls.testtable/MaximumAmount"/>
                            ...
                            <bttdojo:contentpane id="TFInTabbedPane_ContentPane05" title="Tab02">
                              <table style="table-layout:fixed">
                                <tr>
                                  <td align="left" valign="middle">
                                    <bttdojo:label id="TFInTabbedPane_label02" text="tab02" textWrap="false"/>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="left" valign="middle">
                                    <bttdojo:table id="TFInTabbedPane_tableTF3" dataNameForList="AccountInfoList" isPageable="true" textWrap="false" operationName="PAG_PaginationTablePage$TF$TFInTabbedPane_tableTF3" directPagination="true" paginationWhenLoading="false" rowsPerPage="10">
                                      <bttdojo:column widget="TextBox" align="left" dataName="AccountName" width="80" type="String" text="%nls.testtable/AccountName"/>
                                      <bttdojo:column dataNameForList="AccountTypeForSelect" widget="Select" align="left" dataName="AccountType" width="80" labelField="labelField" valueField="valueField" text="%nls.testtable/AccountType"/>
