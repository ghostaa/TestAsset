...
<html>
<!-- Generated from FT.xui by Administrator, on Mon Jan 28 14:33:21 CST 2013 -->
<head>
      ...
      <td align="left" valign="top">
        <bttdojo:form id="FT_form" errorPage="PaginationTablePage/FT/FT.jsp">
          <table>
                  ...
                  <table id="FT_panel01">
                    <tr>
                      <td align="left" valign="middle">
                        <bttdojo:label id="FT_label" text="FTtable" textWrap="false"/>
                      </td>
                    </tr>
                  </table>
              </td>
            ...
            <tr>
              <td align="left" valign="middle">
                <bttdojo:table id="FT_tableFT" dataName="selectAccountList" dataNameForList="AccountInfoList" isPageable="true" selectionMode="multiple" selectionRequired="true" textWrap="false" operationName="PAG_PaginationTablePage$FT$FT_tableFT" directPagination="false" paginationWhenLoading="true" rowsPerPage="10" timeout="800000">
            ...
            <tr>
              <td align="left" valign="top">
                  <table id="FT_panel02">
                    <tr>
                      <td align="left" valign="top">
                        <bttdojo:group id="FT_group" text="Test in group" textWrap="false">
                          <table>
                            <tr>
                              <td align="left" valign="middle">
                                <bttdojo:a id="FT_link" text="Link to \'FTtable in group\'" flowEvent="LinkToGroup" textWrap="false"/>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" valign="middle">
                                <bttdojo:a id="FT_link02" text="Link to \'FTtable in popup group\'" flowEvent="group popup" textWrap="false"/>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" valign="top">
                    ...
                    <tr>
                      <td align="left" valign="top">
                        <bttdojo:group id="FT_group01" text="Test in Tabbedpane" textWrap="false">
                          <table>
                            <tr>
                              <td align="left" valign="middle">
                                <bttdojo:a id="FT_link01" text="Link to \'FTtable in TabbedPane\'" flowEvent="LinkToPane" textWrap="false"/>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" valign="middle">
                                <bttdojo:a id="FT_link04" text="Link to \'FTtable in popup TabbedPane\'" flowEvent="pane popup" textWrap="false"/>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" valign="top">
