...
<html>
<!-- Generated from FTInGroup.xui by Administrator, on Mon Jan 28 14:33:21 CST 2013 -->
<head>
      ...
      <td align="left" valign="top">
        <bttdojo:form id="FTInGroup_form" errorPage="PaginationTablePage/FT/FTInGroup.jsp">
          <table>
                  ...
                  <table id="FTInGroup_panel01">
                    <tr>
                      <td align="left" valign="middle">
                        <bttdojo:a id="FTInGroup_link" text="FTtable" flowEvent="returnToFTtable" textWrap="false"/>
                      </td>
                      <td align="left" valign="middle">
                        <bttdojo:label id="FTInGroup_label" text="-> FTtable in group" textWrap="false"/>
                      </td>
                    </tr>
                  </table>
              </td>
            ...
            <tr>
              <td align="left" valign="top">
                <bttdojo:group id="FTInGroup_group" text="Group" textWrap="false">
                  <table>
                    <tr>
                      <td align="left" valign="middle">
                        <bttdojo:table id="FTInGroup_tableFT" dataNameForList="AccountInfoList" isPageable="true" textWrap="false" operationName="PAG_PaginationTablePage$FT$FTInGroup_tableFT" directPagination="false" paginationWhenLoading="true" rowsPerPage="10">
