...
<html>
<!-- Generated from TTInGroup.xui by Administrator, on Mon Jan 28 14:33:27 CST 2013 -->
<head>
      ...
      <td align="left" valign="top">
        <bttdojo:form id="TTInGroup_form" errorPage="PaginationTablePage/TT/TTInGroup.jsp">
          <table>
                  ...
                  <table id="TTInGroup_panel01">
                    <tr>
                      <td align="left" valign="middle">
                        <bttdojo:a id="TTInGroup_link" text="TTtable" flowEvent="returnToTFtable" textWrap="false"/>
                      </td>
                      <td align="left" valign="middle">
                        <bttdojo:label id="TTInGroup_label" text="-> TTtable in group" textWrap="false"/>
                      </td>
                    </tr>
                  </table>
              </td>
            ...
            <tr>
              <td align="left" valign="top">
                <bttdojo:group id="TTInGroup_group" text="Group" textWrap="false">
                  <table>
                    <tr>
                      <td align="left" valign="top">
                        <bttdojo:table id="TTInGroup_tableTT" dataNameForList="AccountInfoList" isPageable="true" textWrap="false" operationName="PAG_PaginationTablePage$TT$TTInGroup_tableTT" directPagination="true" paginationWhenLoading="true" rowsPerPage="10">
