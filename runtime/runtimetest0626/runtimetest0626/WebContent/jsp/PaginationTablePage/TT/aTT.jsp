...
<html>
<!-- Generated from aTT.xui by Administrator, on Tue Jan 29 10:56:31 CST 2013 -->
<head>
      ...
      <td align="left" valign="top">
        <bttdojo:form id="aTT_form" errorPage="PaginationTablePage/TT/aTT.jsp">
          <table>
                  ...
                  <table id="aTT_panel01">
                    <tr>
                      <td align="left" valign="middle">
                        <bttdojo:label id="aTT_label" text=" TTtable" textWrap="false"/>
                      </td>
                    </tr>
                  </table>
              </td>
            ...
            <tr>
              <td align="left" valign="middle">
                <bttdojo:table id="aTT_tableTT" dataName="AccountInfoRecord" dataNameForList="AccountInfoList" isPageable="true" selectionMode="single" selectionRequired="true" textWrap="false" operationName="PAG_PaginationTablePage$TT$aTT_tableTT" directPagination="true" paginationWhenLoading="true" rowsPerPage="10">
            ...
            <tr>
              <td align="left" valign="top">
                  <table id="aTT_panel02">
                    <tr>
                      <td align="left" valign="top">
                        <bttdojo:group id="aTT_group" text="Test in group" textWrap="false">
                          <table>
                            <tr>
                              <td align="left" valign="middle">
                                <bttdojo:a id="aTT_link" text="Link to \'TTtable in group\'" flowEvent="LinkToGroup" textWrap="false"/>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" valign="middle">
                                <bttdojo:a id="aTT_link02" text="Link to \'TTtable in popup group\'" flowEvent="group popup" textWrap="false"/>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" valign="top">
                    ...
                    <tr>
                      <td align="left" valign="top">
                        <bttdojo:group id="aTT_group01" text="Test in Tabbedpane" textWrap="false">
                          <table>
                            <tr>
                              <td align="left" valign="middle">
                                <bttdojo:a id="aTT_link01" text="Link to \'TTtable in TabbedPane\'" flowEvent="LinkToPane" textWrap="false"/>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" valign="middle">
                                <bttdojo:a id="aTT_link04" text="Link to \'TTtable in popup TabbedPane\'" flowEvent="pane popup" textWrap="false"/>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" valign="top">
