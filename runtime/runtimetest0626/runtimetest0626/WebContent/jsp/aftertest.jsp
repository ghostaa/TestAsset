...
<html>
<!-- Generated from aftertest.xui by Administrator, on Tue Jan 29 10:56:42 CST 2013 -->
<head>
...
<body class="claro" style="visibility:hidden">
  <table id="aftertest_panel">
    <tr>
      <td align="left" valign="top">
        <bttdojo:form id="aftertest_form" errorPage="aftertest.jsp">
          <table>
            <tr>
              <td align="left" valign="middle">
                <bttdojo:table id="aftertest_Table01" dataName="StringTableRow" dataNameForList="StringTableData" sortEnabled="true" selectionMode="single" selectionRequired="true" textWrap="false" isPageable="false">
