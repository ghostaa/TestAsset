...
<html>
<!-- Generated from EditableTableInGroup.xui by Administrator, on Tue Jan 29 10:56:10 CST 2013 -->
<head>
...
<script type="text/javascript" src="<%=JSPUtil.getWebContextRootUrl()%>jsp/EditableTablePage/EditableTableInGroup.js"> </script>
      ...
      <td align="left" valign="middle">
        <bttdojo:form id="EditableTableInGroup_form" errorPage="EditableTablePage/EditableTableInGroup.jsp">
          <table>
            <tr>
              <td align="left" valign="top">
                  <table id="EditableTableInGroup_panel01">
                    <tr>
                      <td align="left" valign="middle">
                        <bttdojo:a id="EditableTableInGroup_link" text="editable table" flowEvent="returnToEditableTable" textWrap="false"/>
                      </td>
                      <td align="left" valign="middle">
                        <bttdojo:label id="EditableTableInGroup_label" text="-> editable table in group" textWrap="false"/>
                      </td>
                    </tr>
                  </table>
              </td>
            ...
            <tr>
              <td align="left" valign="middle">
                <bttdojo:group id="EditableTableInGroup_group" text="Group" textWrap="false">
                  <table>
                    <tr>
                      <td align="left" valign="middle">
                        <bttdojo:table id="EditableTableInGroup_table" dataName="AccountInfoRecord" dataNameForList="EditableAccountList" selectionMode="single" selectionRequired="true" textWrap="false" isPageable="false">
                      ...
                      <td align="left" valign="top">
                        <bttdojo:group id="EditableTableInGroup_group03" text="Group" width="735px" height="176px" textWrap="false">
                          <table style="width:735px;height:176px;">
                            <tr>
                              <td align="left" valign="middle">
                                <bttdojo:label id="EditableTableInGroup_label02" textWrap="false"/>
                              </td>
                            </tr>
                          </table>
                        </bttdojo:group>
                    ...
                    <tr>
                      <td align="left" valign="top">
                        <bttdojo:group id="EditableTableInGroup_group01" text="Group" width="997px" height="263px" textWrap="false">
                          <table style="width:997px;height:263px;">
                            <tr>
                              <td align="left" valign="middle">
                                <bttdojo:button id="EditableTableInGroup_button02" type="button" text="Hide/Show This First Column:AccountName" textWrap="false"/>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" valign="middle">
                                <bttdojo:label id="EditableTableInGroup_label01" for="EditableTableInGroup_button02" textWrap="false"/>
                              </td>
                            </tr>
                          </table>
                        </bttdojo:group>
                    ...
                    <tr>
                      <td align="left" valign="top">
                        <bttdojo:group id="EditableTableInGroup_group02" text="Group" width="997px" height="377px" textWrap="false">
                          <table style="width:997px;height:377px;">
                          </table>
                        </bttdojo:group>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td align="left" valign="top">
                          <table id="EditableTableInGroup_panel02">
                            <tr>
                              <td align="left" valign="middle">
                                <bttdojo:button id="EditableTableInGroup_button" type="submit" text="to group popup page" flowEvent="to group popup page" textWrap="false"/>
                              </td>
                              <td align="left" valign="middle">
                                <bttdojo:button id="EditableTableInGroup_button01" type="submit" text="to pane page" flowEvent="to pane page" textWrap="false"/>
                              </td>
                            </tr>
                          </table>
                      </td>
