...
<html>
<!-- Generated from SelectionResultPage.xui by Administrator, on Tue Jan 29 10:56:36 CST 2013 -->
<head>
      ...
      <td align="left" valign="top">
        <bttdojo:form id="SelectionResultPage_form" errorPage="SelectionResultPage/SelectionResultPage.jsp">
          <table>
                  ...
                  <table id="SelectionResultPage_panel01">
                    <tr>
                      <td align="left" valign="middle">
                        <bttdojo:a id="SelectionResultPage_link_copy" text="back" flowEvent="back" textWrap="false"/>
                      </td>
                      <td align="left" valign="middle">
                        <bttdojo:label id="SelectionResultPage_label" text=" -> Selection Result" textWrap="false"/>
                      </td>
                    </tr>
                  </table>
              </td>
            ...
            <tr>
              <td align="left" valign="middle">
                <bttdojo:table id="SelectionResultPage_table" dataNameForList="selectAccountList" textWrap="false" isPageable="false">
