...
<html>
<!-- Generated from PageRetriever.xui by Administrator, on Mon Jan 28 14:33:17 CST 2013 -->
<head>
...
<bttdojo:form id="PageRetriever_Form01" operationId="pageSortSingleOp" errorPage="PageRetriever.jsp">
  <table>
    <tr>
      <td colspan="4" align="left" valign="middle">
        <bttdojo:table id="PageRetriever_Table01" dataName="item" dataNameForList="items" sortEnabled="true" columnReordering="true" textWrap="false" isPageable="false">
    ...
    <tr>
      ...
      <td align="left" valign="middle">
        <bttdojo:button id="PageRetriever_Button01" type="submit" text="submit" operationId="pageFormSelectSubmitOp" textWrap="false"/>
      </td>
      <td align="left" valign="middle">
        <bttdojo:button id="PageRetriever_Button02" type="reset" text="reset" textWrap="false"/>
      </td>
    </tr>
  </table>
</bttdojo:form>
