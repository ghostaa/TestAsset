...
public class IBK_F_007_SetAppLocale_Sp_Op extends BTTServerOperation {
	
	public void execute() throws Exception {
		System.out.println("***IBK_F_007_SetAppLocaleOp_English****");
		setValueAt("dse_locale", new Locale("es_ES"));
		//setValueAt("dse_locale", Locale.SPANISH);
		setValueAt(HtmlConstants.REPLYPAGE, "index.jsp");
		fireExitEvent("ok");
		 //setValueAt(HtmlConstants.REPLYPAGE, "finalPage.jsp");
		System.out.println("***IBK_F_007_SetAppLocaleOp_English****"+getValueAt("dse_locale"));
	}
