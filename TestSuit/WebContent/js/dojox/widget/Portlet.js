...
dojo.declare("dojox.widget.Portlet", [dijit.TitlePane, dijit._Container],{
	...
	_setClosableAttr: function(data){
		if(data){
				this.closeIcon = this.closeIcon ? this.closeIcon : this._createIcon("dojoxCloseNode", "dojoxCloseNodeHover", dojo.hitch(this, "onClose"));
