...
<html lang="<%=language %>">
<!-- Generated from F003_Result_BodyCell.xui by mashuai, on Fri Jan 17 15:17:06 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="F003_Result_BodyCell_panel" class="BTTTableStyle">
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <bttdojo:form id="F003_Result_BodyCell_form" errorPage="IBK_F_003/F003_1/F003_Result_BodyCell.jsp">
          <table style="width:652px;height:485px;">
            <tr>
              <td colspan="2" align="left" valign="middle" style="vertical-align:middle;">
                <bttdojo:group id="F003_Result_BodyCell_group" text="If the selection mode is single in the previous page, this group is for present the single select result">
                  <div class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F003_Result_BodyCell_label" text="historyID"/>
                      </div>
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F003_Result_BodyCell_label01" dataName="singleSelectedRecord.historyID" text="Label" width="201px" textWrap="false"/>
                      </div>
                    </div>
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F003_Result_BodyCell_label02" text="toAccount"/>
                      </div>
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F003_Result_BodyCell_label03" dataName="singleSelectedRecord.toAccount" text="Label"/>
                      </div>
                    </div>
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F003_Result_BodyCell_label04" text="transfer_date"/>
                      </div>
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F003_Result_BodyCell_label05" dataName="singleSelectedRecord.transfer_date" text="Label"/>
                      </div>
                    </div>
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F003_Result_BodyCell_label08" text="amount"/>
                      </div>
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F003_Result_BodyCell_label09" dataName="singleSelectedRecord.amount" text="Label"/>
                      </div>
                    </div>
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F003_Result_BodyCell_label06" text="comments"/>
                      </div>
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F003_Result_BodyCell_label07" dataName="singleSelectedRecord.comments" text="Label"/>
                      </div>
                    </div>
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
            ...
            <tr>
              <td colspan="2" align="left" valign="middle" style="vertical-align:middle;">
                <bttdojo:group id="F003_Result_BodyCell_group01" style="height:140px;" text="If the selection mode is multiple in the previous page, this group is for present the multiple select result" height="140px">
                  <div style="height:100%;" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:table id="F003_Result_BodyCell_table" dataNameForList="multiSelectedList" isPageable="false">
            ...
            <tr>
              <td colspan="2" align="left" valign="middle" style="vertical-align:middle;">
                <bttdojo:group id="F003_Result_BodyCell_group02" text="The updated table">
                  <div class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                      </div>
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:table id="F003_Result_BodyCell_table_copy" dataName="singleSelectedRecord" dataNameForList="transferHistory" sortEnabled="true" columnReordering="true" selectionMode="single" headerRows="3" isPageable="false">
