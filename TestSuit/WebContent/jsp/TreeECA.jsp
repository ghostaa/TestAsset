...
<html lang="<%=language %>">
<!-- Generated from TreeECA.xui by mashuai, on Fri Jan 17 13:40:49 CST 2014 -->
<head>
...
<script type="text/javascript" data-btt-eca="true" src="<%=JSPUtil.getWebContextRootUrl()%>jsp/TreeECA.js"> </script>
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="TreeECA_panel" class="BTTTableStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="TreeECA_form" errorPage="TreeECA.jsp">
          <div class="BTTTableStyle">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="TreeECA_panel01" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
