...
<html lang="<%=language %>">
<!-- Generated from SelectionResultInPanePage.xui by mashuai, on Fri Jan 17 13:40:46 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="SelectionResultInPanePage_panel" class="BTTTableStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="SelectionResultInPanePage_form" errorPage="SelectionResultPage/SelectionResultInPanePage.jsp">
          <div class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="SelectionResultInPanePage_panel01" class="BTTTableStyle">
                    <div class="BTTRowStyle">
