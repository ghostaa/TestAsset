...
<html lang="<%=language %>">
<!-- Generated from SelectionResultInGroupPage.xui by mashuai, on Fri Jan 17 15:17:31 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="SelectionResultInGroupPage_panel" class="BTTTableStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="SelectionResultInGroupPage_form" errorPage="SelectionResultPage/SelectionResultInGroupPage.jsp">
          <div class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="SelectionResultInGroupPage_panel01" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                    ...
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:table id="SelectionResultInGroupPage_table" dataNameForList="selectAccountList" isPageable="false">
                          <bttdojo:column rowSpan="1" level="1" align="left" noresize="false" dataName="AccountName" width="80" colSpan="1" headerHAlign="left" repeat="true" headerVAlign="left" text="%nls.testtable/AccountName"/>
                          <bttdojo:column rowSpan="1" level="1" align="left" noresize="false" dataName="TradeTime" width="80" colSpan="1" headerHAlign="left" repeat="true" headerVAlign="left" text="%nls.testtable/TradeTime"/>
                          <bttdojo:column rowSpan="1" level="1" align="left" noresize="false" dataName="MaximumAmount" width="80" colSpan="1" headerHAlign="left" repeat="true" headerVAlign="left" text="%nls.testtable/MaximumAmount"/>
                          <bttdojo:column rowSpan="1" level="1" align="left" noresize="false" dataName="AccountOpeningDate" width="80" colSpan="1" headerHAlign="left" repeat="true" headerVAlign="left" text="%nls.testtable/AccountOpeningDate"/>
                          ...
                          <bttdojo:column rowSpan="1" level="1" align="left" noresize="false" dataName="Usable" width="80" colSpan="1" headerHAlign="left" repeat="true" headerVAlign="left" text="%nls.testtable/Usable"/>
                        </bttdojo:table>
                      </div>
                    </div>
                    <div class="BTTRowStyle">
