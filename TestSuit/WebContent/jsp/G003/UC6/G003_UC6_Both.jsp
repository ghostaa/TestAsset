...
<html lang="<%=language %>">
<!-- Generated from G003_UC6_Both.xui by mashuai, on Fri Jan 17 13:39:47 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="G003_UC6_Both_panel" class="BTTTableStyle">
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <bttdojo:label id="G003_UC6_Both_label" text="UC6 checkbox -- alwaysEditable=false -- titleStyle =Both"/>
      </div>
    </div>
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <bttdojo:form id="G003_UC6_Both_Form01" errorPage="G003/UC6/G003_UC6_Both.jsp">
          <div class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:table id="G003_UC6_Both_table" dataName="G003_test_List_result" dataNameForList="G003_test_List" selectionMode="multiple" isPageable="false">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:button id="G003_UC6_Both_button" type="submit" text="submit" flowEvent="submit"/>
              </div>
            </div>
          </div>
      </bttdojo:form>
