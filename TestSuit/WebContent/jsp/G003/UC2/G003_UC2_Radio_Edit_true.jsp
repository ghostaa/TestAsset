...
<html lang="<%=language %>">
<!-- Generated from G003_UC2_Radio_Edit_true.xui by mashuai, on Fri Jan 17 15:16:21 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="G003_UC2_Radio_Edit_true_panel" class="BTTTableStyle">
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <bttdojo:label id="G003_UC2_Radio_Edit_true_label" text="UC2 radio-- alwaysEditable=true"/>
      </div>
    </div>
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <bttdojo:form id="G003_UC2_Radio_Edit_true_Form01" errorPage="G003/UC2/G003_UC2_Radio_Edit_true.jsp">
          <div class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:table id="G003_UC2_Radio_Edit_true_table" dataName="G003_test_List_result" dataNameForList="G003_test_List" selectionMode="multiple" isPageable="false">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:button id="G003_UC2_Radio_Edit_true_button" type="submit" text="submit" flowEvent="submit"/>
              </div>
            </div>
          </div>
      </bttdojo:form>
