...
<html lang="<%=language %>">
<!-- Generated from EditableTableSelectCombo.xui by mashuai, on  -->
<head>
...
<script type="text/javascript" data-btt-eca="true" src="<%=JSPUtil.getWebContextRootUrl()%>jsp/EditableTablePage/EditableTableSelectCombo.js"> </script>
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="EditableTableSelectCombo_panel" class="BTTTableStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="EditableTableSelectCombo_form" errorPage="EditableTablePage/EditableTableSelectCombo.jsp">
          <div class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="EditableTableSelectCombo_panel03" class="BTTTableStyle">
                    <div class="BTTRowStyle">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="EditableTableSelectCombo_panel01" class="BTTTableStyle">
                    <div class="BTTRowStyle">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:table id="EditableTableSelectCombo_table" dataName="selectAccountList" dataNameForList="EditableAccountList" sortEnabled="true" columnReordering="true" selectionMode="multiple" selectionRequired="true" isPageable="false">
                  ...
                  <bttdojo:column level="1" rowSpan="1" widget="Select" align="left" showTooltip="true" width="80" valueField="valueField" tooltipPosition="below" columnTooltip="AccountType" dataName="AccountType" repeat="true" headerVAlign="left" labelField="labelField" colSpan="1" headerHAlign="left" text="%nls.testtable/AccountTypeValue" dataNameForList="AccountTypeForSelect" noresize="false"/>
                  <bttdojo:column level="1" rowSpan="1" widget="ComboBox" align="left" showTooltip="true" width="80" tooltipPosition="above" columnTooltip="Localtion" dataName="Localtion" repeat="true" headerVAlign="left" labelField="labelField" colSpan="1" headerHAlign="left" text="%nls.testtable/Localtion" dataNameForList="LocaltionForComboBox" noresize="false"/>
                  <bttdojo:column level="1" rowSpan="1" widget="ComboBox" align="left" showTooltip="true" width="80" tooltipPosition="right" columnTooltip="Localtion" dataName="Localtion" repeat="true" headerVAlign="left" labelField="labelField" colSpan="1" headerHAlign="left" text="%nls.testtable/LocaltionTypeValue" dataNameForList="LocaltionForComboBox" noresize="false"/>
                </bttdojo:table>
              </div>
            </div>
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="EditableTableSelectCombo_visibility" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="EditableTableSelectCombo_disabled" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="EditableTableSelectCombo_readonly" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" style="vertical-align:">
                  <div id="EditableTableSelectCombo_panel02" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="EditableTableSelectCombo_panel04" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
