...
<html lang="<%=language %>">
<!-- Generated from EditableTableInTabbedPane.xui by mashuai, on Fri Jan 17 13:39:40 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="EditableTableInTabbedPane_panel" class="BTTTableStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="EditableTableInTabbedPane_form" errorPage="EditableTablePage/EditableTableInTabbedPane.jsp">
          <div class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="EditableTableInTabbedPane_panel01" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                ...
                <bttdojo:tabbedpane id="EditableTableInTabbedPane_tabbedPane">
                  <bttdojo:contentpane id="EditableTableInTabbedPane_ContentPane01" title="NormalTab">
                    <div class="BTTTableStyle">
                      ...
                      <div class="BTTRowStyle">
                        <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                            <div id="EditableTableInTabbedPane_panel02" class="BTTTableStyle">
                              <div class="BTTRowStyle">
                                <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
