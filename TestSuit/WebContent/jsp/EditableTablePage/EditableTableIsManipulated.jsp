...
<html lang="<%=language %>">
<!-- Generated from EditableTableIsManipulated.xui by mashuai, on Fri Jan 17 13:39:41 CST 2014 -->
<head>
...
<script type="text/javascript" data-btt-eca="true" src="<%=JSPUtil.getWebContextRootUrl()%>jsp/EditableTablePage/EditableTableIsManipulated.js"> </script>
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="EditableTableIsManipulated_panel" class="BTTTableStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="EditableTableIsManipulated_form" errorPage="EditableTablePage/EditableTableIsManipulated.jsp">
          <div class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="EditableTableIsManipulated_panel03" class="BTTTableStyle">
                    <div class="BTTRowStyle">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="EditableTableIsManipulated_panel01" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:table id="EditableTableIsManipulated_table" dataName="selectAccountList" dataNameForList="EditableAccountList" sortEnabled="true" columnReordering="true" selectionMode="multiple" selectionRequired="true" frozenColumnNum="2" width="800px" height="200px" isPageable="false">
                  ...
                  <bttdojo:column level="1" rowSpan="1" align="left" showTooltip="true" width="80" colSpan="1" hidden="false" headerHAlign="left" tooltipPosition="above" columnTooltip="AccountType" text="%nls.testtable/AccountTypeValue" dataName="AccountType" noresize="false" repeat="true" headerVAlign="left"/>
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="EditableTableIsManipulated_visibility" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="EditableTableIsManipulated_disabled" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="EditableTableIsManipulated_readonly" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" style="vertical-align:">
                  <div id="EditableTableIsManipulated_panel02" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="EditableTableIsManipulated_panel04" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
