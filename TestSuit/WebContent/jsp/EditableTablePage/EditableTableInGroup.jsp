...
<html lang="<%=language %>">
<!-- Generated from EditableTableInGroup.xui by mashuai, on Fri Jan 17 13:39:38 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="EditableTableInGroup_panel" class="BTTTableStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="EditableTableInGroup_form" errorPage="EditableTablePage/EditableTableInGroup.jsp">
          <div class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="EditableTableInGroup_panel01" class="BTTTableStyle">
                    <div class="BTTRowStyle">
              ...
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                <bttdojo:group id="EditableTableInGroup_group" text="Group">
                  <div class="BTTTableStyle">
                    ...
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                          <div id="EditableTableInGroup_panel02" class="BTTTableStyle">
                            <div class="BTTRowStyle">
                              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
