...
<html lang="<%=language %>">
<!-- Generated from G028_Result_none.xui by mashuai, on Fri Jan 17 15:16:52 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="G028_Result_none_panel" class="BTTTableStyle">
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <bttdojo:form id="G028_Result_none_form" errorPage="G028/G028_Result_none.jsp">
          <div style="width:387px;height:260px;" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:label id="G028_Result_none_label" text="whole table submit result"/>
              </div>
            </div>
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:table id="G028_Result_none_table" dataNameForList="accounts" isPageable="false">
