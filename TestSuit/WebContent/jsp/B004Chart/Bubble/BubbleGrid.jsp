...
<html lang="<%=language %>">
<!-- Generated from BubbleGrid.xui by mashuai, on Fri Jan 17 15:16:03 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <bttdojo:datasource id="BubbleGrid_bttStoreWidget" fieldSet="listFL" operation="TableListOp"></bttdojo:datasource>
  <div id="BubbleGrid_panel" class="BTTTableStyle">
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="BubbleGrid_panel01" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="BubbleGrid_dojox_charting_widget_Chart2D" theme="dojox.charting.themes.ThreeD" hMinorLines="true" vMinorLines="true" titleFontColor="#8000FF" y_titleFontColor="#00FF00" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div name="series" class="series" plot="dojox_charting_widget_plot" store="$BTT_DOS('listFL', {mapOpt:{'value':{'size':'@size','x':function(s,i){return i;},'y':'@amount'}}}, 'BubbleGrid_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="BubbleGrid_panel02" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="BubbleGrid_dojox_charting_widget_Chart2D01" theme="dojox.charting.themes.MiamiNice" hMajorLines="false" vMajorLines="false" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div name="series" class="series" plot="dojox_charting_widget_plot01" store="$BTT_DOS('listFL', {mapOpt:{'value':{'size':'@size','x':function(s,i){return i;},'y':'@amount'}}}, 'BubbleGrid_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="BubbleGrid_panel03" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="BubbleGrid_dojox_charting_widget_Chart2D02" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div name="series" class="series" plot="dojox_charting_widget_plot02" store="$BTT_DOS('listFL', {mapOpt:{'value':{'size':'@size','x':function(s,i){return i;},'y':'@amount'}}}, 'BubbleGrid_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="BubbleGrid_panel04" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="BubbleGrid_panel05" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="BubbleGrid_panel06" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
    ...
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="BubbleGrid_panel07" class="BTTTableStyle">
          </div>
      </div>
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="BubbleGrid_panel08" class="BTTTableStyle">
          </div>
      </div>
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="BubbleGrid_panel09" class="BTTTableStyle">
          </div>
      </div>
    </div>
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="BubbleGrid_panel10" class="BTTTableStyle">
          </div>
      </div>
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="BubbleGrid_panel11" class="BTTTableStyle">
          </div>
      </div>
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="BubbleGrid_panel12" class="BTTTableStyle">
          </div>
      </div>
    </div>
  </div>
