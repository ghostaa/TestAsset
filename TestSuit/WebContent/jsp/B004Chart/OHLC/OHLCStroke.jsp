...
<html lang="<%=language %>">
<!-- Generated from OHLCStroke.xui by mashuai, on Fri Jan 17 13:39:33 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <bttdojo:datasource id="OHLCStroke_bttStoreWidget" fieldSet="StockList" operation="StockOp"></bttdojo:datasource>
  <div id="OHLCStroke_panel" class="BTTTableStyle">
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="OHLCStroke_panel01" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="OHLCStroke_dojox_charting_widget_Chart2D" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
                        <div class="plot" tension="x" name="dojox_charting_widget_plot" type="OHLC" labels="false" stroke="{'style':'Solid','color':'#FF0000','width':2}"></div>
                      <div name="series" class="series" plot="dojox_charting_widget_plot" store="$BTT_DOS('StockList', {mapOpt:{'value':{'high':'@high','low':'@low','mid':'@mid','close':'@close','open':'@open'}}}, 'OHLCStroke_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <div style="width:400px;height:300px;" id="OHLCStroke_dojox_charting_widget_Chart2D_copy" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
              ...
              <div name="series" class="series" plot="dojox_charting_widget_plot_copy" store="$BTT_DOS('StockList', {mapOpt:{'value':{'high':'@high','low':'@low','close':'@close','open':'@open'}}}, 'OHLCStroke_bttStoreWidget')"></div>
        </div>
      </div>
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <div style="width:400px;height:300px;" id="OHLCStroke_dojox_charting_widget_Chart2D_copy01" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
              ...
              <div name="series" class="series" plot="dojox_charting_widget_plot_copy01" store="$BTT_DOS('StockList', {mapOpt:{'value':{'high':'@high','low':'@low','close':'@close','open':'@open'}}}, 'OHLCStroke_bttStoreWidget')"></div>
        </div>
      </div>
    </div>
    <div class="BTTRowStyle">
    ...
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <div style="width:400px;height:300px;" id="OHLCStroke_dojox_charting_widget_Chart2D_copy02" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
              ...
              <div name="series" class="series" plot="dojox_charting_widget_plot_copy02" store="$BTT_DOS('StockList', {mapOpt:{'value':{'high':'@high','low':'@low','close':'@close','open':'@open'}}}, 'OHLCStroke_bttStoreWidget')"></div>
        </div>
      </div>
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <div style="width:400px;height:300px;" id="OHLCStroke_dojox_charting_widget_Chart2D_copy03" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
              ...
              <div name="series" class="series" plot="dojox_charting_widget_plot_copy03" store="$BTT_DOS('StockList', {mapOpt:{'value':{'high':'@high','low':'@low','close':'@close','open':'@open'}}}, 'OHLCStroke_bttStoreWidget')"></div>
        </div>
      </div>
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <div style="width:400px;height:300px;" id="OHLCStroke_dojox_charting_widget_Chart2D_copy04" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
              ...
              <div name="series" class="series" plot="dojox_charting_widget_plot_copy04" store="$BTT_DOS('StockList', {mapOpt:{'value':{'high':'@high','low':'@low','close':'@close','open':'@open'}}}, 'OHLCStroke_bttStoreWidget')"></div>
        </div>
      </div>
    </div>
    <div class="BTTRowStyle">
    ...
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <div style="width:400px;height:300px;" id="OHLCStroke_dojox_charting_widget_Chart2D_copy03_copy" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
              ...
              <div name="series" class="series" plot="dojox_charting_widget_plot_copy03_copy" store="$BTT_DOS('StockList', {mapOpt:{'value':{'high':'@high','low':'@low','close':'@close','open':'@open'}}}, 'OHLCStroke_bttStoreWidget')"></div>
        </div>
      </div>
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <div style="width:400px;height:300px;" id="OHLCStroke_dojox_charting_widget_Chart2D_copy03_copy01" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
              ...
              <div name="series" class="series" plot="dojox_charting_widget_plot_copy03_copy01" store="$BTT_DOS('StockList', {mapOpt:{'value':{'high':'@high','low':'@low','close':'@close','open':'@open'}}}, 'OHLCStroke_bttStoreWidget')"></div>
        </div>
      </div>
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <div style="width:400px;height:300px;" id="OHLCStroke_dojox_charting_widget_Chart2D_copy03_copy02" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
              ...
              <div name="series" class="series" plot="dojox_charting_widget_plot_copy03_copy02" store="$BTT_DOS('StockList', {mapOpt:{'value':{'high':'@high','low':'@low','close':'@close','open':'@open'}}}, 'OHLCStroke_bttStoreWidget')"></div>
        </div>
      </div>
    </div>
    <div class="BTTRowStyle">
    ...
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <div style="width:400px;height:300px;" id="OHLCStroke_dojox_charting_widget_Chart2D_copy03_copy03" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
              ...
              <div name="series" class="series" plot="dojox_charting_widget_plot_copy03_copy03" store="$BTT_DOS('StockList', {mapOpt:{'value':{'high':'@high','low':'@low','close':'@close','open':'@open'}}}, 'OHLCStroke_bttStoreWidget')"></div>
        </div>
      </div>
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <div style="width:400px;height:300px;" id="OHLCStroke_dojox_charting_widget_Chart2D_copy03_copy04" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
              ...
              <div name="series" class="series" plot="dojox_charting_widget_plot_copy03_copy04" store="$BTT_DOS('StockList', {mapOpt:{'value':{'high':'@high','low':'@low','close':'@close','open':'@open'}}}, 'OHLCStroke_bttStoreWidget')"></div>
        </div>
      </div>
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <div style="width:400px;height:300px;" id="OHLCStroke_dojox_charting_widget_Chart2D_copy03_copy05" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
              ...
              <div name="series" class="series" plot="dojox_charting_widget_plot_copy03_copy05" store="$BTT_DOS('StockList', {mapOpt:{'value':{'high':'@high','low':'@low','close':'@close','open':'@open'}}}, 'OHLCStroke_bttStoreWidget')"></div>
        </div>
      </div>
    </div>
    <div class="BTTRowStyle">
