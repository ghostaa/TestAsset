...
<html lang="<%=language %>">
<!-- Generated from StackedBars.xui by mashuai, on Fri Jan 17 15:16:09 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <bttdojo:datasource id="StackedBars_bttStoreWidget" fieldSet="listFL" operation="TableListOp"></bttdojo:datasource>
  <div id="StackedBars_panel" class="BTTTableStyle">
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="StackedBars_panel01" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="StackedBars_dojox_charting_widget_Chart2D" theme="dojox.charting.themes.Claro" vMajorLines="false" vMinorLines="true" y_titleFontColor="#FF8080" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div name="series" class="series" plot="dojox_charting_widget_plot" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                      <div name="series01" class="series" plot="dojox_charting_widget_plot" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
            <div class="BTTRowStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="StackedBars_panel02" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="StackedBars_dojox_charting_widget_Chart2D01" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div name="series" class="series" plot="dojox_charting_widget_plot01" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                      <div name="series01" class="series" plot="dojox_charting_widget_plot01" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
            <div class="BTTRowStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="StackedBars_panel06" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="StackedBars_dojox_charting_widget_Chart2D05" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div name="series" class="series" plot="dojox_charting_widget_plot05" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                      <div name="series01" class="series" plot="dojox_charting_widget_plot05" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="StackedBars_panel05" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="StackedBars_dojox_charting_widget_Chart2D04" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div name="series" class="series" plot="dojox_charting_widget_plot02" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                      <div name="series01" class="series" plot="dojox_charting_widget_plot02" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="StackedBars_panel04" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="StackedBars_dojox_charting_widget_Chart2D03" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div name="series" class="series" plot="dojox_charting_widget_plot03" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                      <div name="series01" class="series" plot="dojox_charting_widget_plot03" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="StackedBars_panel03" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="StackedBars_dojox_charting_widget_Chart2D02" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div name="series" class="series" plot="dojox_charting_widget_plot04" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                      <div name="series01" class="series" plot="dojox_charting_widget_plot04" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="StackedBars_panel07" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="StackedBars_dojox_charting_widget_Chart2D08" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div name="series" class="series" plot="dojox_charting_widget_plot06" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                      <div name="series01" class="series" plot="dojox_charting_widget_plot06" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="StackedBars_panel08" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="StackedBars_dojox_charting_widget_Chart2D07" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div name="series" class="series" plot="dojox_charting_widget_plot07" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                      <div name="series01" class="series" plot="dojox_charting_widget_plot07" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="StackedBars_panel09" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="StackedBars_dojox_charting_widget_Chart2D06" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
                        <div class="plot" name="dojox_charting_widget_plot08" type="StackedBars" markers="true" labels="false" animate="true" stroke="{'style':'Solid'}"></div>
                        <div class="action" type="Tooltip" plot="dojox_charting_widget_plot08"></div>
                        <div class="action" type="Highlight" plot="dojox_charting_widget_plot08"></div>
                        <div class="action" type="Shake" plot="dojox_charting_widget_plot08"></div>
                        <div class="action" type="Magnify" plot="dojox_charting_widget_plot08" scale="1"></div>
                        <div class="action" type="MoveSlice" plot="dojox_charting_widget_plot08" scale="1" shift="1"></div>
                      <div name="series" class="series" plot="dojox_charting_widget_plot08" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                      <div name="series01" class="series" plot="dojox_charting_widget_plot08" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="StackedBars_panel10" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="StackedBars_dojox_charting_widget_Chart2D09" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div stroke="{'style':'Dash','color':'#0000FF','width':2}" name="series" class="series" plot="dojox_charting_widget_plot09" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                      <div stroke="{'color':'#FF0000','width':2}" name="series01" class="series" plot="dojox_charting_widget_plot09" store="$BTT_DOS('listFL', {mapOpt:{'value':'@amount'}}, 'StackedBars_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
