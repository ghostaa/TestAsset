...
<html lang="<%=language %>">
<!-- Generated from MarkersPlot.xui by mashuai, on Fri Jan 17 15:16:07 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <bttdojo:datasource id="MarkersPlot_bttStoreWidget" fieldSet="listFL" operation="TableListOp"></bttdojo:datasource>
  <bttdojo:datasource id="MarkersPlot_bttStoreWidget01" fieldSet="AnnualStatementList" operation="AnnualStatementOp"></bttdojo:datasource>
  <div id="MarkersPlot_panel" class="BTTTableStyle">
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="MarkersPlot_panel01" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="MarkersPlot_dojox_charting_widget_Chart2D" theme="dojox.charting.themes.Julie" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div name="series" class="series" plot="dojox_charting_widget_plot" store="$BTT_DOS('listFL', {mapOpt:{'value':{'x':function(s,i){return i;},'y':'@amount'}}}, 'MarkersPlot_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="MarkersPlot_panel02" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="MarkersPlot_dojox_charting_widget_Chart2D01" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div name="series" class="series" plot="dojox_charting_widget_plot01" store="$BTT_DOS('listFL', {mapOpt:{'value':{'x':function(s,i){return i;},'y':'@amount'}}}, 'MarkersPlot_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="MarkersPlot_panel03" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="MarkersPlot_dojox_charting_widget_Chart2D03" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div name="series" class="series" plot="dojox_charting_widget_plot02" store="$BTT_DOS('listFL', {mapOpt:{'value':{'x':function(s,i){return i;},'y':'@amount'}}}, 'MarkersPlot_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="MarkersPlot_panel04" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="MarkersPlot_dojox_charting_widget_Chart2D02" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div name="series" class="series" plot="dojox_charting_widget_plot03" store="$BTT_DOS('listFL', {mapOpt:{'value':{'tooltip':'@label','x':function(s,i){return i;},'y':'@amount'}}}, 'MarkersPlot_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="MarkersPlot_panel05" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="MarkersPlot_dojox_charting_widget_Chart2D04" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div name="series" class="series" plot="dojox_charting_widget_plot04" store="$BTT_DOS('listFL', {mapOpt:{'value':{'x':function(s,i){return i;},'y':'@amount'}}}, 'MarkersPlot_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="MarkersPlot_panel06" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <div style="width:400px;height:300px;" id="MarkersPlot_dojox_charting_widget_Chart2D05" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
                      ...
                      <div name="series" class="series" plot="dojox_charting_widget_plot05" store="$BTT_DOS('listFL', {mapOpt:{'value':{'x':function(s,i){return i;},'y':'@amount'}}}, 'MarkersPlot_bttStoreWidget')"></div>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <div style="width:400px;height:300px;" id="MarkersPlot_dojox_charting_widget_Chart2D02_copy" theme="dojox.charting.themes.Claro" dojoType="dojox.charting.widget.Chart2D">
                <div class="plot" name="dojox_charting_widget_plot03_copy" type="Markers" minBarSize="15" labels="false" stroke="{'style':'Solid','color':'#FF8080','width':3}"></div>
                <div class="action" type="Tooltip" plot="dojox_charting_widget_plot03_copy"></div>
              <div stroke="{'style':'ShortDashDot','color':'#8000FF','width':2}" name="series" class="series" plot="dojox_charting_widget_plot03_copy" store="$BTT_DOS('AnnualStatementList', {mapOpt:{'value':{'tooltip':'@profit','x':'@profit','y':'@weight'}}}, 'MarkersPlot_bttStoreWidget01')"></div>
        </div>
      </div>
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="MarkersPlot_panel08" class="BTTTableStyle">
          </div>
      </div>
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="MarkersPlot_panel09" class="BTTTableStyle">
          </div>
      </div>
    </div>
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="MarkersPlot_panel10" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:label id="MarkersPlot_label06" text="set x and y"/>
              </div>
            </div>
          </div>
      </div>
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="MarkersPlot_panel11" class="BTTTableStyle">
          </div>
      </div>
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
          <div id="MarkersPlot_panel12" class="BTTTableStyle">
          </div>
      </div>
    </div>
  </div>
