...
<html lang="<%=language %>">
<!-- Generated from EditSelectionResultInPanePage.xui by mashuai, on Fri Jan 17 13:39:37 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="EditSelectionResultInPanePage_panel" class="BTTTableStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="EditSelectionResultInPanePage_form" errorPage="EditSelectionResultPage/EditSelectionResultInPanePage.jsp">
          <div class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="EditSelectionResultInPanePage_panel01" class="BTTTableStyle">
                    <div class="BTTRowStyle">
