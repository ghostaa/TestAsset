...
<html lang="<%=language %>">
<!-- Generated from TFInGroup.xui by mashuai, on Fri Jan 17 15:17:20 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="TFInGroup_panel" class="BTTTableStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="TFInGroup_form" errorPage="PaginationTablePage/TF/TFInGroup.jsp">
          <div class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="TFInGroup_panel01" class="BTTTableStyle">
                    <div class="BTTRowStyle">
