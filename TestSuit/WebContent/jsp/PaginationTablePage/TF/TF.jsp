...
<html lang="<%=language %>">
<!-- Generated from TF.xui by mashuai, on Fri Jan 17 15:17:20 CST 2014 -->
<head>
...
<script type="text/javascript" data-btt-eca="true" src="<%=JSPUtil.getWebContextRootUrl()%>jsp/PaginationTablePage/TF/TF.js"> </script>
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="TF_panel" class="BTTTableStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="TF_form" errorPage="PaginationTablePage/TF/TF.jsp">
          <div class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="TF_panel01" class="BTTTableStyle">
                    <div class="BTTRowStyle">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="TF_panel02" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                    ...
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                          <div id="TF_panel03" class="BTTTableStyle">
                            <div class="BTTRowStyle">
                              <div class="BTTCellStyle" style="vertical-align:">
                              </div>
                            </div>
