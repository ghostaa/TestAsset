...
<html lang="<%=language %>">
<!-- Generated from FFInGroup.xui by mashuai, on Fri Jan 17 15:17:15 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="FFInGroup_panel" class="BTTTableStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="FFInGroup_form" errorPage="PaginationTablePage/FF/FFInGroup.jsp">
          <div class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="FFInGroup_panel01" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                    ...
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:table id="FFInGroup_tableFF" dataNameForList="AccountInfoList" isPageable="true" operationName="PAG_PaginationTablePage$FF$FFInGroup_tableFF" directPagination="false" paginationWhenLoading="false" rowsPerPage="10">
                          ...
                          <bttdojo:column level="1" rowSpan="1" widget="Select" align="left" showTooltip="true" width="80" valueField="valueField" tooltipPosition="right" columnTooltip="AccountType" dataName="AccountType" repeat="true" headerVAlign="left" labelField="labelField" colSpan="1" headerHAlign="left" text="%nls.testtable/AccountType" dataNameForList="AccountTypeForSelect" noresize="false"/>
