...
<html lang="<%=language %>">
<!-- Generated from FTInGroup.xui by mashuai, on Fri Jan 17 15:17:17 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="FTInGroup_panel" class="BTTTableStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="FTInGroup_form" errorPage="PaginationTablePage/FT/FTInGroup.jsp">
          <div class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="FTInGroup_panel01" class="BTTTableStyle">
                    <div class="BTTRowStyle">
