...
<html lang="<%=language %>">
<!-- Generated from aTT.xui by mashuai, on Fri Jan 17 15:17:23 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="aTT_panel" class="BTTTableStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="aTT_form" errorPage="PaginationTablePage/TT/aTT.jsp">
          <div class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="aTT_panel01" class="BTTTableStyle">
                    <div class="BTTRowStyle">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="aTT_panel02" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                        <bttdojo:group id="aTT_group" text="Test in group">
                          <div class="BTTTableStyle">
                            ...
                            <div class="BTTRowStyle">
                              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                                  <div id="aTT_panel04" class="BTTTableStyle">
                                    <div class="BTTRowStyle">
                      ...
                      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                        <bttdojo:group id="aTT_group01" text="Test in Tabbedpane">
                          <div class="BTTTableStyle">
                            <div class="BTTRowStyle">
                              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                                <bttdojo:a id="aTT_link01" text="Link to 'TTtable in TabbedPane' (frozen column and noresize testing)" flowEvent="LinkToPane"/>
                              </div>
                            </div>
                            <div class="BTTRowStyle">
                              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                                <bttdojo:a id="aTT_link04" text="Link to 'TTtable in popup TabbedPane' (frozen column and noresize testing)" flowEvent="pane popup"/>
                              </div>
                            </div>
                            <div class="BTTRowStyle">
                              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                                  <div id="aTT_panel05" class="BTTTableStyle">
                                    <div class="BTTRowStyle">
                                      <div class="BTTCellStyle" style="vertical-align:">
                                      </div>
                                    </div>
                    ...
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                          <div id="aTT_panel03" class="BTTTableStyle">
                            <div class="BTTRowStyle">
                              <div class="BTTCellStyle" style="vertical-align:">
                              </div>
                              <div class="BTTCellStyle" style="vertical-align:">
