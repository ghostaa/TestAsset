...
<html lang="<%=language %>">
<!-- Generated from TTInGroup.xui by mashuai, on Fri Jan 17 13:40:37 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="TTInGroup_panel" class="BTTTableStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="TTInGroup_form" errorPage="PaginationTablePage/TT/TTInGroup.jsp">
          <div class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="TTInGroup_panel01" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                    ...
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                        <bttdojo:table id="TTInGroup_tableTT" dataNameForList="AccountInfoList" isPageable="true" operationName="PAG_PaginationTablePage$TT$TTInGroup_tableTT" directPagination="true" paginationWhenLoading="true" rowsPerPage="10">
                          ...
                          <bttdojo:column level="1" rowSpan="1" widget="TextBox" align="left" showTooltip="true" width="80" colSpan="1" headerHAlign="left" tooltipPosition="above" columnTooltip="AccountOpeningDate" text="%nls.testtable/AccountOpeningDate" pattern="yyyy-MM-dd" dataName="AccountOpeningDate" noresize="false" type="Date" repeat="true" headerVAlign="left"/>
                          <bttdojo:column numberType="double" level="1" rowSpan="1" widget="TextBox" align="left" width="80" headerHAlign="left" colSpan="1" text="%nls.testtable/Rate" dataName="Rate" noresize="false" type="Number" repeat="true" headerVAlign="left" decimalPlaces="3"/>
