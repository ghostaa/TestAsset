...
<html lang="<%=language %>">
<!-- Generated from F013_Sample.xui by mashuai, on Fri Jan 17 13:40:25 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="F013_Sample_null" class="BTTTableStyle">
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="F013_Sample_form" errorPage="IBK_F_013/F013_Sample.jsp">
          <div style="width:561px;height:258px;" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:label id="F013_Sample_label" text="IBK-F013 sample page"/>
              </div>
            </div>
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:table id="F013_Sample_table" dataName="multiSelectedList" dataNameForList="transferHistory" selectionMode="multiple" cellOverflow="whole" indirectSelection="true" isPageable="false">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                  <div id="F013_Sample_panel" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:a id="F013_Sample_link" text="link to single selection mode" flowEvent="single" width="274px" textWrap="false"/>
                      </div>
                    </div>
                  </div>
              </div>
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:button id="F013_Sample_button" type="submit" text="Submit" flowEvent="viewEvt"/>
              </div>
            </div>
          </div>
      </bttdojo:form>
