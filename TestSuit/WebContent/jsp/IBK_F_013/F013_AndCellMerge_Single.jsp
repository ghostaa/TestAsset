...
<html lang="<%=language %>">
<!-- Generated from F013_AndCellMerge_Single.xui by mashuai, on Fri Jan 17 15:17:07 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="F013_AndCellMerge_Single_null" class="BTTTableStyle">
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="F013_AndCellMerge_Single_form" errorPage="IBK_F_013/F013_AndCellMerge_Single.jsp">
          <div style="width:561px;height:258px;" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:label id="F013_AndCellMerge_Single_label" text="IBK-F013 sample page"/>
              </div>
            </div>
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:table id="F013_AndCellMerge_Single_table" dataName="singleSelectedRecord" dataNameForList="transferHistory" selectionMode="single" cellOverflow="whole" cellMerge="[{\"start\":1,\"major\":2,\"row\":0,\"end\":2}]" indirectSelection="true" isPageable="false">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                  <div id="F013_AndCellMerge_Single_panel" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                      </div>
                    </div>
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:button id="F013_AndCellMerge_Single_button" type="submit" text="Submit" flowEvent="viewEvt"/>
              </div>
            </div>
          </div>
      </bttdojo:form>
