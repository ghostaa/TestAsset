...
<html lang="<%=language %>">
<!-- Generated from F013_Result_Sample.xui by mashuai, on Fri Jan 17 15:17:08 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="F013_Result_Sample_panel" class="BTTTableStyle">
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <bttdojo:form id="F013_Result_Sample_form" errorPage="IBK_F_013/F013_Result_Sample.jsp">
          <table style="width:652px;height:485px;">
            <tr>
              <td colspan="2" align="left" valign="middle" style="vertical-align:middle;">
                <bttdojo:group id="F013_Result_Sample_group" text="If the selection mode is single in the previous page, this group is for present the single select result">
                  <div class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F013_Result_Sample_label" text="historyID"/>
                      </div>
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F013_Result_Sample_label01" dataName="singleSelectedRecord.historyID" text="Label" width="201px" textWrap="false"/>
                      </div>
                    </div>
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F013_Result_Sample_label02" text="toAccount"/>
                      </div>
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F013_Result_Sample_label03" dataName="singleSelectedRecord.toAccount" text="Label"/>
                      </div>
                    </div>
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F013_Result_Sample_label04" text="transfer_date"/>
                      </div>
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F013_Result_Sample_label05" dataName="singleSelectedRecord.transfer_date" text="Label"/>
                      </div>
                    </div>
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F013_Result_Sample_label08" text="amount"/>
                      </div>
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F013_Result_Sample_label09" dataName="singleSelectedRecord.amount" text="Label"/>
                      </div>
                    </div>
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F013_Result_Sample_label06" text="comments"/>
                      </div>
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:label id="F013_Result_Sample_label07" dataName="singleSelectedRecord.comments" text="Label"/>
                      </div>
                    </div>
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
            ...
            <tr>
              <td colspan="2" align="left" valign="middle" style="vertical-align:middle;">
                <bttdojo:group id="F013_Result_Sample_group01" style="height:140px;" text="If the selection mode is multiple in the previous page, this group is for present the multiple select result" height="140px">
                  <div style="height:100%;" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:table id="F013_Result_Sample_table" dataNameForList="multiSelectedList" isPageable="false">
            ...
            <tr>
              <td colspan="2" align="left" valign="middle" style="vertical-align:middle;">
                <bttdojo:group id="F013_Result_Sample_group02" text="The updated table">
                  <div class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                      </div>
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:table id="F013_Result_Sample_table_copy" dataName="singleSelectedRecord" dataNameForList="transferHistory" sortEnabled="true" columnReordering="true" selectionMode="single" headerRows="3" isPageable="false">
