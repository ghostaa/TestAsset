...
<html lang="<%=language %>">
<!-- Generated from F013_AndCellMerge_Multi.xui by mashuai, on Fri Jan 17 15:17:07 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="F013_AndCellMerge_Multi_null" class="BTTTableStyle">
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="F013_AndCellMerge_Multi_form" errorPage="IBK_F_013/F013_AndCellMerge_Multi.jsp">
          <div style="width:561px;height:258px;" class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:label id="F013_AndCellMerge_Multi_label" text="IBK-F013 sample page"/>
              </div>
            </div>
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:table id="F013_AndCellMerge_Multi_table" dataName="multiSelectedList" dataNameForList="transferHistory" selectionMode="multiple" cellOverflow="whole" cellMerge="[{\"start\":1,\"major\":2,\"row\":0,\"end\":2}]" indirectSelection="true" isPageable="false">
            ...
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:a id="F013_AndCellMerge_Multi_link" text="link to the single selection mode" flowEvent="single"/>
              </div>
            </div>
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                <bttdojo:button id="F013_AndCellMerge_Multi_button" type="submit" text="Submit" flowEvent="viewEvt"/>
              </div>
            </div>
          </div>
      </bttdojo:form>
