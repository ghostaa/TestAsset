...
<html lang="<%=language %>">
<!-- Generated from UnsettledBill.xui by mashuai, on Fri Jan 17 13:39:25 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="UnsettledBill_panel" class="BTTTableStyle">
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <bttdojo:form id="UnsettledBill_form" errorPage="B001/UnsettledBill.jsp">
          <table>
            <tr>
              <td align="left" valign="middle" style="width:187px;vertical-align:middle;">
                <bttdojo:label id="UnsettledBill_label03" text="Selected Row Num:"/>
              </td>
              <td align="left" valign="middle" style="vertical-align:middle;">
                <bttdojo:label id="UnsettledBill_label04" dataName="RowNum" text="Label"/>
              </td>
            </tr>
            <tr>
              <td align="left" valign="middle" style="width:187px;vertical-align:middle;">
                <bttdojo:label id="UnsettledBill_label" text="%nls.testb001/queryUnsettledBill"/>
              </td>
              <td align="left" valign="middle" style="vertical-align:middle;">
              </td>
            </tr>
            <tr>
              <td align="right" valign="middle" style="width:187px;height:40px;vertical-align:middle;">
                <bttdojo:label id="UnsettledBill_label01" text="%nls.testb001/Bill_CurType"/>
              </td>
              <td align="left" valign="middle" style="height:40px;vertical-align:middle;">
                <bttdojo:combo id="UnsettledBill_combo" dataName="SearchCondition.CurType" storeURL="listFiles/curType.js"/>
              </td>
            </tr>
            <tr>
              ...
              <td align="left" valign="middle" style="vertical-align:middle;">
                <bttdojo:button id="UnsettledBill_button" type="submit" text="%nls.testb001/Confirm" flowEvent="search"/>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="2" align="left" valign="middle" style="vertical-align:middle;">
                  <div style="width:663px;" id="UnsettledBill_panel01" class="BTTTableStyle">
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                        <bttdojo:table id="UnsettledBill_table" dataNameForList="UnsettledBillList" isPageable="true" operationName="PAG_B001$UnsettledBill_table" directPagination="true" paginationWhenLoading="true" rowsPerPage="10" timeout="8000">
                    ...
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="center" style="vertical-align:middle;">
                          <div id="UnsettledBill_panel02" class="BTTTableStyle">
                            <div class="BTTRowStyle">
                              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                                <bttdojo:button id="UnsettledBill_button02" type="button" text="%nls.testb001/print"/>
                              </div>
                              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                              </div>
                              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                                <bttdojo:button id="UnsettledBill_button03" type="button" text="%nls.testb001/download"/>
                              </div>
                              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                              </div>
                              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
                                <bttdojo:button id="UnsettledBill_button01" type="submit" text="%nls.testb001/Close" flowEvent="close"/>
                              </div>
                            </div>
                          </div>
                      </div>
