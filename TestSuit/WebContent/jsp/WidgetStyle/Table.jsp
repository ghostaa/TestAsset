...
<html lang="<%=language %>">
<!-- Generated from Table.xui by mashuai, on Fri Jan 17 15:17:36 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="Table_cpnl" class="BTTTableStyle">
    <div class="BTTRowStyle">
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
<div style="display:inline-block;" class="tableStyle tableStyle1">        <bttdojo:table id="Table_wtbl" dataNameForList="tableList" isPageable="false">
    ...
    <div class="BTTRowStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
        <bttdojo:image id="Table_image" location="img/pic/table.png" tabIndex="-1"/>
      </div>
    </div>
  </div>
