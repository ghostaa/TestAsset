...
<html lang="<%=language %>">
<!-- Generated from NonEditableTableInGroup.xui by mashuai, on Fri Jan 17 13:40:28 CST 2014 -->
<head>
...
<%request.setAttribute("dse_sessionId", session.getId()); %>
  <div id="NonEditableTableInGroup_panel" class="BTTTableStyle">
      ...
      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
        <bttdojo:form id="NonEditableTableInGroup_form" errorPage="NonEditableTablePage/NonEditableTableInGroup.jsp">
          <div class="BTTTableStyle">
            <div class="BTTRowStyle">
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                  <div id="NonEditableTableInGroup_panel01" class="BTTTableStyle">
                    <div class="BTTRowStyle">
              ...
              <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                <bttdojo:group id="NonEditableTableInGroup_group" text="Group">
                  <div class="BTTTableStyle">
                    ...
                    <div class="BTTRowStyle">
                      <div class="BTTCellStyle" align="left" style="vertical-align:top;">
                          <div id="NonEditableTableInGroup_panel02" class="BTTTableStyle">
                            <div class="BTTRowStyle">
                              <div class="BTTCellStyle" align="left" style="vertical-align:middle;">
