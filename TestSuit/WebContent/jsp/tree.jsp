...
<html lang="<%=language %>">
<!-- Generated from tree.xui by mashuai, on Fri Jan 17 13:41:22 CST 2014 -->
<head>
...
<script type="text/javascript" data-btt-eca="true" src="<%=JSPUtil.getWebContextRootUrl()%>jsp/tree.js"> </script>
